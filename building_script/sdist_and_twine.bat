...
cd C:\Users\amcsparron\Desktop\Python_Projects\IndexedChoiceSelector
echo pwd changed to C:\Users\amcsparron\Desktop\Python_Projects\IndexedChoiceSelector
